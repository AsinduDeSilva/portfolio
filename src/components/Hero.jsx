...
export default function Hero() {
  return (
    <div className='flex min-h-[90vh] bg-[#1D1F23] xl:px-24 lg:px-0 pb-10 md:pb-0'>
    <Grid container>
        <Grid item order={{xs:1, md:0}} xs={12} md={6} sx={{display: 'flex', alignItems:'center', justifyContent:'center'}}>
            <div className='text-white flex flex-col justify-center px-5'>
                <div className='md:ml-5 lg:ml-14 lg:-mt-8'>
                    ...
                    <h1 className='text-5xl sm:text-6xl font-[800] my-2 mt-3 sm:mt-5'>I'm a <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#6649be] to-[#a45dac]'>Full Stack</span></h1>
                    <h1 className='text-5xl sm:text-6xl font-[800] mb-5'>Web Developer.</h1>
                    ...
                    <Button sx={{width: '120px'}} variant='contained' color='secondary'>Hire Me</Button>

                </div>  
            </div>
        </Grid>
        <Grid item xs={12} md={6} sx={{display: 'flex', alignItems:'center', justifyContent:'center'}}>
            <div className='flex items-center justify-center md:mr-8 lg:mr-14 xl:mr-0 sm:mt-10 sm:mb-20 md:mt-0 md:mb-0'>
                <div className='bg-[#383B40] rounded-[50%] h-[300px] w-[300px] sm:h-[450px] sm:w-[450px] lg:h-[550px] lg:w-[550px] flex items-end justify-center overflow-hidden'>
                    <img className='h-[280px] sm:h-[400px] lg:h-[500px]' src={dp} alt="" />
                </div>
            </div>
        </Grid>
    </Grid>  
