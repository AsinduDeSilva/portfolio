...
export default function Hero() {
  return (
    <div className='flex min-h-[43rem] md:min-h-[650px] bg-[#191b1e] xl:px-24 lg:px-0 pb-10 md:pb-0'>
    <Grid container>
        <Grid item order={{xs:1, md:0}} xs={12} md={6} sx={{display: 'flex', alignItems:'center', justifyContent:'center'}}>
            <div className='text-white flex flex-col justify-center px-5'>
                <div className='md:ml-5 lg:ml-14 lg:-mt-8'>
                    <motion.p 
                        className='sm:text-lg font-semibold text-[#DADADA]'
                        initial={{opacity: 0, y: 150}}
                        animate={{opacity: 1, y: 0}}
                        transition={{duration: 0.5, ease:'easeOut'}}
                    >
                        Hi I'm Asindu De Silva
                    </motion.p>
                    <motion.div
                        initial={{opacity: 0, y: 150}}
                        animate={{opacity: 1, y: 0}}
        ...
        <Grid item xs={12} md={6} sx={{display: 'flex', alignItems:'center', justifyContent:'center'}}>
            <motion.div className='flex items-center justify-center md:mr-8 lg:mr-14 xl:mr-0 sm:mt-10 sm:mb-20 md:mt-0 md:mb-0 py-10'
                initial={{opacity: 0, y: 150}}
                animate={{opacity: 1, y: 0}}
